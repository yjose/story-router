...
(function (global, factory) {
  ...
  (factory((global.storyRouter = {}),global.React,global.reactDom));
  ...
  */
  ...
  function (_React$Component) {
    _inherits$10(FuzzyPicker, _React$Component);

    function FuzzyPicker(props) {
      var _this;

      _classCallCheck$10(this, FuzzyPicker);

      _this = _possibleConstructorReturn$10(this, (FuzzyPicker.__proto__ || Object.getPrototypeOf(FuzzyPicker)).call(this));
      _this.state = {
        selectedIndex: 0,
      ...
      value: function onInputChanged(_ref) {
        ...
        if (value.length) {
          ...
          var items = this.props.items.filter(function (item) {
            return fuzzysearch_1(value.toLowerCase(), _this2.props.itemValue(item).toLowerCase());
          });
          this.setState({
  ...
  function (_FuzzyPicker) {
    _inherits$10(AsyncFuzzyPicker, _FuzzyPicker);

    function AsyncFuzzyPicker() {
      _classCallCheck$10(this, AsyncFuzzyPicker);

      return _possibleConstructorReturn$10(this, (AsyncFuzzyPicker.__proto__ || Object.getPrototypeOf(AsyncFuzzyPicker)).apply(this, arguments));
    }
  ...
  /*#__PURE__*/
  function (_React$Component) {
    _inherits$10(FuzzyWrapper, _React$Component);

    function FuzzyWrapper(props) {
      var _this;

      _classCallCheck$10(this, FuzzyWrapper);

      _this = _possibleConstructorReturn$10(this, (FuzzyWrapper.__proto__ || Object.getPrototypeOf(FuzzyWrapper)).call(this));
      _this.state = {
        isOpen: false
  ...
  var Palette = function Palette(props) {
    return React.createElement(FuzzyWrapper, {
      ...
      popup: function popup(isOpen, onClose) {
        return React.createElement(FuzzySearchExample, _extends$10({
          isOpen: isOpen
        }, props, {
          onClose: onClose
        }));
  ...
  var FuzzySearchExample = function FuzzySearchExample(props) {
    return React.createElement(FuzzyPicker, _extends$10({}, props, {
  ...
  unwrapExports(reactCodemirror2);
  var reactCodemirror2_1 = reactCodemirror2.Controlled;
  var reactCodemirror2_2 = reactCodemirror2.UnControlled;
  ...
  /*#__PURE__*/
  function (_React$Component) {
    _inherits$10(Prop, _React$Component);

    function Prop(props) {
      var _this;

      _classCallCheck$10(this, Prop);

      _this = _possibleConstructorReturn$10(this, (Prop.__proto__ || Object.getPrototypeOf(Prop)).call(this, props));
    ...
    _createClass(Prop, [{
      ...
      value: function render() {
        ...
        return React.createElement("div", {
          ...
          className: "s-invalid"
        })), React.createElement(reactCodemirror2_1, {
          value: value,
          options: options,
  ...
  var WithProp = function WithProp(Comp) {
    return function () {
      ...
      function (_React$PureComponent) {
        _inherits$10(P, _React$PureComponent);

        function P(props) {
          var _this;

          _classCallCheck$10(this, P);

          _this = _possibleConstructorReturn$10(this, (P.__proto__ || Object.getPrototypeOf(P)).call(this, props));
