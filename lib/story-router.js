...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-router'), require('react-fuzzy-picker'), require('react-codemirror2'), require('react-dom'), require('react-router-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-router', 'react-fuzzy-picker', 'react-codemirror2', 'react-dom', 'react-router-dom'], factory) :
  (factory((global.storyRouter = {}),global.React,global.reactRouter,global.reactFuzzyPicker,global.reactCodemirror2,global.reactDom,global.reactRouterDom));
}(this, (function (exports,React,reactRouter,reactFuzzyPicker,reactCodemirror2,reactDom,reactRouterDom) { 'use strict';
